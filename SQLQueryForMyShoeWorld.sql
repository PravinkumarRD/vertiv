...
INSERT INTO Categories (CategoryName,Description) VALUES('Sports Shoes','All companies Sports shoes');
INSERT INTO Categories (CategoryName,Description) VALUES('Formal Shoes','All companies Formal shoes');
INSERT INTO Categories (CategoryName,Description) VALUES('Loafer Shoes','All companies Loafer shoes');
...
GO
create view CategoryWiseProducts as select P.ProductName, P.UnitPrice, P.UnitPrice*P.Discount as 'TotalPrice', C.CategoryName from Categories C inner join Products P on C.CategoryId=P.CategoryId;
GO

Create procedure GetCategoryWiseProducts(
	@CategoryId int
)
AS
BEGIN
	select P.ProductName, P.UnitPrice, P.UnitPrice*P.Discount as 'TotalPrice', C.CategoryName from Categories C inner join Products P on C.CategoryId=P.CategoryId where C.CategoryId=@CategoryId;
END;